...
<body>
    <header class="top-head">
        ...
        <label for="aside" class="hide-aside">
    ...
    <section class="down-content">
        <aside class="aside-left">
            ...
            <ul class="menu">
                <li class="menu__item {{ is_active('admin.dashboard') }}">
                    <a href="{{ route('admin.dashboard') }}" class="menu__link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home">
                            <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path>
                            <polyline points="9 22 9 12 15 12 15 22"></polyline>
                        </svg>
                        <span class="link_text">Главная</span>
                    </a>
                </li>
                <li class="menu__item {{ is_active('admin.news.*') }}">
                    <a href="{{ route('admin.news.index') }}" class="menu__link">
                ...
                <li class="menu__item">
                    <a href="#" class="menu__link">
                        ...
                        <span class="link_text">Категории новостей</span>
                    </a>
                </li>
                <li class="menu__item">
                    <a href="#" class="menu__link">
                        ...
                        <span class="link_text">Истории</span>
                    </a>
                </li>
                <li class="menu__item">
                    <a href="#" class="menu__link">
                        ...
                        <span class="link_text">Комментарии</span>
                    </a>
                </li>
                <li class="menu__item">
                    <a href="#" class="menu__link">
                        ...
                        <span class="link_text">Страницы</span>
                    </a>
                </li>
                <li class="menu__item">
                    <a href="#" class="menu__link">
                        ...
                        <span class="link_text">Теги</span>
                    </a>
                </li>
                <li class="menu__item">
                    <a href="#" class="menu__link">
                        ...
                        <span class="link_text">Пользователи</span>
                    </a>
                </li>
                <li class="menu__item">
                    <a href="#" class="menu__link">
                        ...
                        <span class="link_text">Права пользователей</span>
                    </a>
                </li>
            </ul>
        ...
        <div class="content blueScroll">
            <div class="scroll-content">
                <div class="col-lg-12 bg-white shadow no-gutters">
                    @yield('content')
